...
Gui, Add, Checkbox, x145 y38 h14 vNameChk gNameChk right,Name-Check
...
if (kbmpprt <> "")
	{
		...
		FileDelete,%MediaCenter_Profille_Template%
...
guicontrolget,EnableLogging,,EnableLogging
complist:= LVGetCheckedItems("SysListView321","VoRteX_GUI")
fullist= %complist%
